.. -*- mode: rst -*-
==========================================
 Keyboards for the English language
==========================================

This directory contains source files and build instructions for developing
keyboards for the English language. The data and implementations
...
* http://giellatekno.uit.no/engdoc/index.html
* http://divvun.no/doc/tools/docu-eng-manual.html
...
The English keyboard sources can be acquired using the `Giella SVN
